...
if (isset($_POST['tweet'])) {
    ...
    $community_id = isset($_POST['community_id']) ? User::checkInput($_POST['community_id']) : null;
        $redirectTo = "../communitiesfeed.php";
            if($community_id !== null) {
        $redirectTo .= "?community_id=" . urlencode($community_id);
       }
...
} else header('location: ../communitiesfeed.php');
?>