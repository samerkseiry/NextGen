...
<head>
    ...
    <title> <?php echo $profileData->name; ?> (@<?php echo $profileData->username; ?>) | NextGen</title>
          ...
          <div class="box-home feed">
               <div class="container">
                 <div   class="row position-fixed box-name">
                       <div class="col-xs-2">
                       <a href="javascript: history.go(-1);"> <img src="assets/images/back.png" alt="Back" class="arrow-style" height="40px" width="40px"> </a>
                       </div>
                       <div class="col-xs-10">
