        ...
        <div class="sidebar-left">
          ...
          <div class="grid-sidebar bg-active" style="margin-top: 12px">
            <div class="icon-sidebar-align">
              <img src="assets/images/homeicon.png" alt="" height="26.25px" width="26.25px" />
            </div>
        ...
        <div class="border-right">
          <div class="grid-toolbar-center">
            <div class="center-input-search">
                ...
                <div class="row">
    <div class="col-xs-1">
        <!-- history go to the previous page and specific section user come from -->
        <a href="javascript: history.go(-1);">
            <img src="assets/images/back.png" alt="Back" class="arrow-style" height="40px" width="40px">
        </a>
    </div>
                ...
                <div class="grid-reactions">
                  ...
                  <div  class="grid-box-reaction"  >
                    ...
                    data-user="<?php echo $user_id; ?>">
                      ...
                      <!-- <i class="fas fa-heart liked"></i> ghayarneha la tsir linked bel database --> 
